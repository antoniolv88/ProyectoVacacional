...
public class Principal extends JFrame implements ActionListener {
    ...
    public Principal() {
        ...
        setIconImage(new ImageIcon(getClass().getResource("images/completoAnto.png")).getImage());
        Bienvenida ventanaBienvenida = new Bienvenida();
        nombreAdministrador = ventanaBienvenida.texto;

        mb = new JMenuBar();
        mb.setBackground(new Color(100,100,100));
        setJMenuBar(mb);

        menuOpciones = new JMenu("Opciones");
        menuOpciones.setBackground(new Color(100,100,100));
        menuOpciones.setFont(new Font("Andale Mono", 1, 14));
        menuOpciones.setForeground(new Color(255, 255, 255));
        mb.add(menuOpciones);

        menuCalcular = new JMenu("Calcular");
        menuCalcular.setBackground(new Color(100,100,100));
        menuCalcular.setFont(new Font("Andale Mono", 1, 14));
        menuCalcular.setForeground(new Color(255, 255, 255));
        mb.add(menuCalcular);

        menuAcercaDe = new JMenu("Acerca de");
        menuAcercaDe.setBackground(new Color(100,100,100));
        ...
        menuColorFondo.setForeground(new Color(100,100,100));
        menuOpciones.add(menuColorFondo);

        miCalculo = new JMenuItem("Vacaciones");
        miCalculo.setFont(new Font("Andale Mono", 1, 14));
        miCalculo.setForeground(new Color(100,100,100));
        menuCalcular.add(miCalculo);
        miCalculo.addActionListener(this);

        miRojo = new JMenuItem("Rojo");
        miRojo.setFont(new Font("Andale Mono", 1, 14));
        miRojo.setForeground(new Color(100,100,100));
        menuColorFondo.add(miRojo);
        miRojo.addActionListener(this);

        miNegro = new JMenuItem("Negro");
        miNegro.setFont(new Font("Andale Mono", 1, 14));
        miNegro.setForeground(new Color(100,100,100));
        menuColorFondo.add(miNegro);
        miNegro.addActionListener(this);

        miMorado = new JMenuItem("Morado");
        miMorado.setFont(new Font("Andale Mono", 1, 14));
        miMorado.setForeground(new Color(100,100,100));
        menuColorFondo.add(miMorado);
        miMorado.addActionListener(this);

        miNuevo = new JMenuItem("Nuevo");
        miNuevo.setFont(new Font("Andale Mono", 1, 14));
        miNuevo.setForeground(new Color(100,100,100));
        menuOpciones.add(miNuevo);
        miNuevo.addActionListener(this);

        miElCreador = new JMenuItem("El creador");
        miElCreador.setFont(new Font("Andale Mono", 1, 14));
        miElCreador.setForeground(new Color(100,100,100));
        menuAcercaDe.add(miElCreador);
        miElCreador.addActionListener(this);

        miSalir = new JMenuItem("Salir");
        miSalir.setFont(new Font("Andale Mono", 1, 14));
        miSalir.setForeground(new Color(100,100,100));
        menuOpciones.add(miSalir);
        miSalir.addActionListener(this);

        ImageIcon imagen = new ImageIcon("images/logoCompletoAnto.png");
        ...
        txtNombreTrabajador.setForeground(new java.awt.Color(100,100,100));
        ...
        txtAPaternoTrabajador.setForeground(new java.awt.Color(100,100,100));
        ...
        txtAMaternoTrabajador.setForeground(new java.awt.Color(100,100,100));
        ...
        comboDepartamento.setForeground(new java.awt.Color(100,100,100));
        ...
        comboAntiguedad.setForeground(new java.awt.Color(100,100,100));
        add(comboAntiguedad);
        ...
        textarea1.setForeground(new Color(100,100,100));
        textarea1.setText("\n   Aquí aparece el resultado del cálculo de las vacaciones.");
        scrollpane1 = new JScrollPane(textarea1);
        scrollpane1.setBounds(220, 333, 385, 90);
        add(scrollpane1);

        labelfooter = new JLabel("©2022 ANTONIO LORENZO | Todos los derechos reservados");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == miElCreador) {
            ...
            JOptionPane.showMessageDialog(null, "Desarrollado por ANTONIO LORENZO\n"
